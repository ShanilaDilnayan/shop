...
<head>
    ...
    <title>Advanced Search | E-lap</title>
...
<body style="background-color: #74EBD5;background-image: linear-gradient(90deg,#74EBD5 0%,#E2FF5F  100%);">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="offset-lg-1 col-12 col-lg-10  bg-body rounded mt-4 mb-2">
                <div class="row my-4 ">
                    ...
                    <div class="offset-lg-1 col-12 col-lg-10">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 mt-2 mb-1 d-grid">
                                <button class="btn text-white" style="background-color: #C70039 ;" onclick="advancedsearch(0);">Search</button>
                            </div>
                            <div class="col-12">
            ...
            <div class="offset-lg-1 col-12 col-lg-10 bg-body rounded mb-4">
                <div class="row">
