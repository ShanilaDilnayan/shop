...
if(isset($_SESSION["u"])){
    ...
    Database::iud("UPDATE `user` SET `fname`='".$fname."',`lname`='".$lname."',`mobile`='".$mobile."'
            ...
            if($address_num == 1){
                ...
                Database::iud("UPDATE `user_has_address` SET `line_1`='".$line1."',
                `line_2`='".$line2."',`city_id`='".$city."',`postal_code`='".$pcode."' WHERE 
                `user_email`='".$_SESSION["u"]["email"]."'");

            }else{

                Database::iud("INSERT INTO `user_has_address`
                (`line_1`,`line_2`,`user_email`,`city_id`,`postal_code`) VALUES
